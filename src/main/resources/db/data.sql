...
-- review_tb
INSERT INTO review_tb (user_id, counsel_id, content, score, created_at, updated_at)
VALUES (1, 1, '상담사가 매우 친절하고 도움이 많이 되었습니다.', 3.5, NOW(), NOW()),
       (2, 2, '상담 내용이 정말 유익했고, 큰 도움이 되었습니다.', 4.5, NOW(), NOW()),
       (3, 3, '친절하고 세심하게 상담해주셔서 감사했습니다.', 5.0, NOW(), NOW()),
       (4, 4, '상담사가 문제를 잘 이해해주고 해결책을 제시해주었습니다.', 4.5, NOW(), NOW()),
       (5, 5, '상담 후 마음이 많이 편안해졌습니다. 감사합니다.', 5.0, NOW(), NOW()),
       (6, 6, '상담 시간이 짧아서 아쉬웠지만, 유익했습니다.', 4.5, NOW(), NOW()),
       (7, 7, '상담사가 제 고민을 잘 들어주었고, 조언도 좋았습니다.', 5.0, NOW(), NOW()),
       (8, 8, '상담이 매우 도움이 되었고, 다음에도 이용하고 싶습니다.', 5.0, NOW(), NOW()),
       (9, 9, '상담사가 전문적이고 친절해서 좋았습니다.', 4.5, NOW(), NOW()),
       (10, 10, '상담이 끝난 후 많은 도움이 되었습니다.', 3.5, NOW(), NOW()),
       (11, 11, '상담을 통해 많은 것을 배울 수 있었습니다.', 4.5, NOW(), NOW()),
       (12, 12, '친절하고 전문적인 상담 감사합니다.', 4.5, NOW(), NOW()),
       (13, 13, '상담이 매우 유익하고 도움이 많이 되었습니다.', 5.0, NOW(), NOW()),
       (14, 14, '상담사가 문제를 잘 파악하고 해결책을 제시해주었습니다.', 3.5, NOW(), NOW()),
       (15, 15, '상담 후 마음이 많이 편안해졌습니다.', 4.5, NOW(), NOW()),
       (16, 16, '상담 시간 동안 많은 것을 배울 수 있었습니다.', 5.0, NOW(), NOW()),
       (17, 17, '상담사가 제 고민을 잘 들어주고 해결책을 제시해주었습니다.', 4.5, NOW(), NOW()),
       (18, 18, '상담이 매우 유익했고, 큰 도움이 되었습니다.', 34.5, NOW(), NOW()),
       (19, 19, '친절하고 전문적인 상담 감사합니다.', 4.0, NOW(), NOW()),
       (20, 20, '상담사가 문제를 잘 이해하고 해결책을 제시해주었습니다.', 4.5, NOW(), NOW()),
       (21, 21, '상담 후 마음이 많이 편안해졌습니다.', 4.5, NOW(), NOW()),
       (22, 22, '상담 시간이 짧아서 아쉬웠지만, 유익했습니다.', 3.5, NOW(), NOW()),
       (23, 23, '상담사가 제 고민을 잘 들어주었고, 조언도 좋았습니다.', 4.0, NOW(), NOW()),
       (24, 24, '상담이 매우 도움이 되었고, 다음에도 이용하고 싶습니다.', 5.0, NOW(), NOW()),
       (25, 25, '상담사가 전문적이고 친절해서 좋았습니다.', 4.5, NOW(), NOW()),
       (26, 26, '상담이 끝난 후 많은 도움이 되었습니다.', 4.0, NOW(), NOW()),
       (27, 27, '상담을 통해 많은 것을 배울 수 있었습니다.', 4.5, NOW(), NOW()),
       (28, 28, '친절하고 전문적인 상담 감사합니다.', 5.0, NOW(), NOW()),
       (29, 29, '상담이 매우 유익하고 도움이 많이 되었습니다.', 4.5, NOW(), NOW()),
       (30, 30, '상담사가 문제를 잘 파악하고 해결책을 제시해주었습니다.', 4.5, NOW(), NOW());
