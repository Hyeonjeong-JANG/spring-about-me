...
VALUES ('CLIENT', 'mimi@nate.com', '1234', '최미정', '0101112222', '/images/sad.webp', '1990-01-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'hae@nate.com', '1234', '장현재', '0101112222', '/images/angry.webp', '1992-02-02', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'sae@nate.com', '1234', '이사이', '0101112222', '/images/happy.webp', '1994-03-03', 'OTHER', NOW(),
        NOW()),
       ('CLIENT', 'jin@nate.com', '1234', '김진호', '0101112222', '/images/angry.webp', '1996-04-04', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'ji@nate.com', '1234', '서지호', '0101112222', '/images/sad.webp', '1998-05-05', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'suji@nate.com', '1234', '박수지', '0101113333', '/images/happy.webp', '1990-06-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'jong@nate.com', '1234', '김종현', '0101114444', '/images/happy.webp', '1991-07-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'yuna@nate.com', '1234', '윤아름', '0101115555', '/images/joyful.webp', '1992-08-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'minho@nate.com', '1234', '최민호', '0101116666', '/images/sad.webp', '1993-09-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'sohee@nate.com', '1234', '이소희', '0101117777', '/images/joyful.webp', '1994-10-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'doyoung@nate.com', '1234', '박도영', '0101118888', '/images/happy.webp', '1995-11-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'yeseul@nate.com', '1234', '김예슬', '0101119999', '/images/joyful.webp', '1996-12-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'dongwoo@nate.com', '1234', '정동우', '0101110000', '/images/angry.webp', '1997-01-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'hyunjoo@nate.com', '1234', '박현주', '0102221111', '/images/sad.webp', '1998-02-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'sanghoon@nate.com', '1234', '김상훈', '0102222222', '/images/shy.webp', '1999-03-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'eunji@nate.com', '1234', '서은지', '0102223333', '/images/shy.webp', '2000-04-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'woojin@nate.com', '1234', '이우진', '0102224444', '/images/shy.webp', '2001-05-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'jiwon@nate.com', '1234', '최지원', '0102225555', '/images/angry.webp', '2002-06-01', 'WOMAN', NOW(),
        NOW()),
       ('CLIENT', 'taeyoung@nate.com', '1234', '박태영', '0102226666', '/images/angry.webp', '2003-07-01', 'MAN', NOW(),
        NOW()),
       ('CLIENT', 'soyoung@nate.com', '1234', '김소영', '0102227777', '/images/shy.webp', '2004-08-01', 'WOMAN', NOW(),
        NOW());
