...
VALUES (1, '집에 가고 싶어서 고민 적습니다. 회사에서 일하는 중인데 집이 너무 가고 싶어요.', '집에 가고 싶어요', 'GENERAL_CONCERNS', NOW()),
       ...
       (1,  '진로선택은 어떻게 해야 하나요. 꿈이 없어요. 뭐를 하고 싶은지도 모르겠어요. 이럴 때는 어떻게 해야 해요.', '진로 선택은 어떻게 하나요', 'CAREER_JOBS', NOW()),
       (1,  '회사에 취직하기 싫어요. 하지만 회사를 취업해야 하는 현실이에요. 너무 막막합니다. 현실은 취업해야 하지만, 옛날 힘들었던 경험으로 다시 그 길을 걸을 생각만으로 가슴이 답답해지고 무섭습니다. 이럴 때는 어떻게 해야 하나요.', '회사', 'CAREER_JOBS', NOW()),
       (1,  '회사에 들어가기 위해서는 면접을 봐야 하는데, 저는 사람들이랑 이야기하는 것이 너무 어렵습니다. 사람들이랑 대화하는 것이 무서워요. 압박면접들도 많고, 말을 조리있게 잘하지 못합니다. 당장 다음주부터 면접에 나가야하는데, 생각만해도 어떻게 될지 예상이 갑니다. 면접에 가면 무조건, 안 좋은 이미지로 보일 것 같은데 이럴 때는 어떻게 해야하나요.', '면접에 가기 무서워요', 'CAREER_JOBS', NOW()),
       (1,  '전공을 공부하면서, 항상 맞지 않는다는 느낌이 들었습니다. 그렇지만, 당장에 제가 할 수 있는 일이라고는 온통 전공과 관련된 일 뿐입니다. 지금껏 주변사람들의 말과 저 자신에 대한 용기가 없어서, 항상 결단을 내지 못해요. 그리고 이내 도망쳐버리고 맙니다. 다른 전공의 강의들이나 수업들을 들어볼까 생각하다가도 경제적으로 여유로운 편은 아니라 여러 강의들을 마음껏 수강해볼 수도 없고 지금 여러 상황들로 여유가 잘 나지 않습니다. 어떻게 해야 하나요. ', '용기가 잘 나지 않아요.', 'CAREER_JOBS', NOW()),
       (1,  '저는 어떻게 해야 하나요. 저는 어릴 적부터 크게 하고 싶은 것도 없고 크게 싫어하는 것도 없었습니다. 그래서 주변에서 나에게 주어진 일에 열심히 집중을 하며 살았습니다. 그렇게 항상 언젠가는 하고 싶은 것들이, 내 진로, 삶의 방향들이 자연스럽게 정립되겠지하고 생각했지만 성인이 된 지금도 여전히, 저는 뚜렷한 목표, 진로 방향이 없습니다. 그냥 지금 하고 있는 것들이 안맞는다는 생각밖에 들지 않아요. 내일도 지금하고 있는 일을 하고 앞으로도 계속 이 일을 해야 한다는 것에 마음이 너무 답답합니다. 지금 상황이 너무 마음에 들지 않아요. 하지만 지금 이 상황에서는 옛날처럼 버티는 것밖에 없다는 주변의 조언을 들었습니다. 그 말을 들으니 막막합니다.', '정말 모르겠습니다.', 'CAREER_JOBS', NOW()),
       ...
       (4, '친구를 좋아하게 되었어요. 만나면 항상 싸우던 친구가 있었는데, 그 친구가 얼마 전부터, 친구이상으로 느껴져요. 하지만, 여전히 저희들은 만나면 싸우기만해요. 앞으로 사귀게 되어도 성격이나 맞는 구석이 하나도 없어요. 하지만, 포기가 안돼요. 앞으로를 생각하면, 포기를 하는 것이 맞는데 마음대로 잘 되지 않습니다... 어떻게 해야 하나요......', '잘 맞지 않아요.', 'RELATIONSHIPS', NOW()),
       (4, '제 연인을 정말 사랑합니다. 하지만, 때때로 의견이 맞지 않을 때나, 화가 날 때에 폭언을 합니다. 어쩔 때는 욕도 합니다. 그리고는 시간이 지나면, 저에게 사과를 합니다. 성장과정에서 좋지 못한 습관을 길렀다고 합니다. 그 애도 열심히 노력하는 것 같은데 순간 순간 그 모습들이 튀어나와요. 그럴 때에는 많은 생각이 들면서, 제가 하찮아지는 느낌입니다. 하지만 싸울 때 외에는 항상 다정하고 세상 좋은 연인입니다. 사람 중에 완벽한 사람은 없다는 데, 이런 부분은 제가 인내해야하는 부분인가요? 어느정도까지 봐줘야 하나요? 적절한 기준이 있나요?', '폭언을 해요.','RELATIONSHIPS', NOW()),
       ...
       (5, '운동을 시작해보려고 하는데... 날씨는 너무 덥고 나갈 생각만해도 기운이 쭉 빠집니다. 움직이는 것조차 힘든데, 어떻게 운동을 할까싶네요. 하지만 저녁이 되어 잘 때가 되면, 항상 제 모습을 되돌아보며, 운동을 결심하지만, 실행하는 것이 너무 어려워요. 저는 땀 나는 것도 너무 싫고, 돈도 많지 않아 pt를 맏지도 못해요.제가 운동을 할 수 있는 방법이 있을까요?', '나가기 싫어요', 'GENERAL_CONCERNS', NOW()),
